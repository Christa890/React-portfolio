...
import pfp from "../IMG-6114.png.jpg";
import {
  Bars3Icon,
  XMarkIcon,
  SunIcon,
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <p>
                    Frontend Developer who loves innovation and challenges. Passionate about web development
                    and in pursuit of excellence.
                  </p>
                </div>
                <div className="mt-10 flex items-center justify-center gap-x-4">
                  <button className="btn btn-outline btn-square" >
                  <a href="https://in.linkedin.com/in/christa-joshy-0869651b6">
                    <svg
